...
- Create Angular project with ng: `ng new green_thumb_web_app_ng.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`green_thumb_web_app_ng.client.esproj`).
